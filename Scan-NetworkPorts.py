...
if len(sys.argv) != 4:
    print("Usage:\r\n"
          "./Scan-NetworkPorts.py <target_ip> [single | range | list] [<port_number> | <port_range> | <file_name>]\r\n"
          "\r\n"
          "Examples:\r\n"
          "./Scan-NetworkPorts.py 192.168.0.10 single 445\r\n"
          "./Scan-NetworkPorts.py 192.168.0.10 list port_list.txt\r\n"
          "./Scan-NetworkPorts.py 192.168.0.10 range 1,65535\r\n"
          "\r\n")
    exit()
...
print("\r\nPort scan has completed, any open ports are displayed.")